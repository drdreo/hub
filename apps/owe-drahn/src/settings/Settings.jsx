...
const Feed = ({ disabled }) => (
    ...
    >
        ...
        <g>
            <path
                className="window"
                d="M-232,414.5h-38c-2.8,0-5-2.3-5-5v-25c0-2.8,2.3-5,5-5h38c2.8,0,5,2.3,5,5v25
...
const Leave = () => (
    <svg version="1.1" id="Leave" x="0px" y="0px" viewBox="-49 141 512 512">
        ...
        <path
            className="arrow"
            d="M440.5,400.9c0.1-0.2,0.2-0.3,0.3-0.5c0.3-0.4,0.5-0.9,0.6-1.4c0.1-0.2,0.1-0.4,0.2-0.6c0.2-0.9,0.2-1.8,0-2.7
	...
	c-2.7,2.7-2.7,7.2,0,9.9s7.2,2.7,9.9,0l0,0l50-50C440,401.6,440.3,401.3,440.5,400.9z"
        />
        <path
            d="M332.7,430c-3.9,0-7,3.1-7,7v147.6H145.5V209.4h180.2V357c0,3.9,3.1,7,7,7s7-3.1,7-7l0,0V202.4c0-3.9-3.1-7-7-7H145.5V167
    ...
    return (
        <div className={`menu ${menuClass} ${props.className}`}>
            ...
            <div className={`menu-entries`}>
                ...
                <button className="menu__button" onClick={handleToggleSound}>
                    <Speaker disabled={!soundEnabled} />
                </button>
                <button className="menu__button" onClick={handleToggleFeed}>
