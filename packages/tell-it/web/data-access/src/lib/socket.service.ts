...
import { HomeInfo, ServerJoined, UserLeft, UserOverview } from "@tell-it-web/domain/api-interfaces";
...
export class SocketService {
    ...
    gameStatus(): Observable<GameStatus> {
        return this.socket
            .fromEvent<ServerGameStatusUpdate>(ServerEvent.GameStatus)
    ...
    finishVoteUpdate(): Observable<string[]> {
        return this.socket
            .fromEvent<ServerFinishVoteUpdate>(ServerEvent.VoteFinish)
