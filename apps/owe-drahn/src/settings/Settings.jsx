        ...
        return (
            <div className={`menu ${menuClass} ${this.props.className}`} >
                ...
                <div className={`menu-entries`}>
                    ...
                    <a href="#" onClick={() => this.props.toggleSound()}>
                        Sound {soundEnabled ? "true" : "false"}
                        <img className="icon" width="32" height="32" src={this.icon} />
                    </a>
                    <a href="#" onClick={() => this.props.toggleFeed()}>
                        Feed {feedEnabled ? "true" : "false"}
                    </a>
                </div>
            </div>
        );
